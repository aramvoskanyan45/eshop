...
$config['csrf_exclude_uris'] = array(
    'admin/product/process_bulk_upload', 'login/logout', 'cart/place-order','my-account/[a-z_-]+','my-account/update-order-item-status', 'my-account/update_web_fcm', 'admin/custom_sms/view_sms_by_id', 'admin/Sms_gateway_settings/update_notification_module', 'admin/product/get_subcategory', 'admin/themes/switch',
