    ...
    public function add_seller()
    {
        ...
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            if (!$this->form_validation->run()) {
                ...
                $permmissions['view_order_otp'] = (isset($_POST['view_order_otp']) && !empty($_POST['view_order_otp'])) ? 1 : 0;
                $permmissions['assign_delivery_boy'] = (isset($_POST['assign_delivery_boy']) && !empty($_POST['assign_delivery_boy'])) ? 1 : 0;
