            ...
            <div class="col-md-5">
                <div class="post-header mb-5">
                    ...
                    <div class="col-lg-10 d-flex flex-row pt-2 gap-1 product-page-div p-0">
                        ...
                        <button class="item-like text-decoration-none btn-outline-red btn-sm rounded-pill w-15 p-0 fs-19 fav_button_dif add-to-fav-btn <?= ($product['product'][0]['is_favorite'] == 1) ? 'fa fa-heart text-danger' : 'fa fa-heart-o' ?>" href="#" title="<?= !empty($this->lang->line('add_to_wishlist')) ? $this->lang->line('add_to_wishlist') : 'Add To wishlist' ?>" data-product-id="<?= $product['product'][0]['id'] ?>">
                            <i class=""></i>
                        </button>
