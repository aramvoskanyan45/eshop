        ...
        <div class="col-md-12 col-12 mt-4 pt-2">
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade bg-white show active shadow rounded p-4 text-center" id="dash" role="tabpanel" aria-labelledby="dashboard">
                    ...
                    <a class="btn btn-primary btn-sm" href="<?=base_url('my_account/wallet')?>"><?= !empty($this->lang->line('return_to_wallet')) ? $this->lang->line('return_to_wallet') : 'Return to wallet' ?></a>
                </div>
            </div>
        </div>
    </div>
