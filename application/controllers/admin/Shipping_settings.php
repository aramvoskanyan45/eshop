    ...
    public function update_shipping_settings()
    {
        ...
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            if (!$this->form_validation->run()) {
                ...
                $fields = ['local_shipping_method', 'shiprocket_shipping_method', 'email', 'password', 'webhook_token', 'standard_shipping_free_delivery', 'minimum_free_delivery_order_amount'];
