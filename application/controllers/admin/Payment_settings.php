    ...
    public function update_payment_settings()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            if (!$this->form_validation->run()) {
                ...
                $fields = [
                    'paypal_payment_method', 'paypal_mode', 'paypal_business_email', 'currency_code',
                    ...
                    'myfatoorah_payment_method', 'myfatoorah_token', 'myfatoorah_payment_mode', 'myfatoorah_language', 'myfatoorah__webhook_url',
                    ...
                    'direct_bank_transfer', 'account_name', 'account_number', 'bank_name', 'bank_code', 'notes', 'cod_method', 'temp'
                ];
