...
class Setting_model extends CI_Model
{
    ...
    public function update_system_setting($post)
    {
        ...
        $system_data = [
            ...
            // 'refer_earn_amount_for_referal' => $post['refer_earn_amount_for_referal'],
            ...
            'pincode_wise_deliverability' => (isset($post['pincode_wise_deliverability']) && !empty($post['pincode_wise_deliverability'])) ? '1' : '0',
            'city_wise_deliverability' => (isset($post['city_wise_deliverability']) && !empty($post['city_wise_deliverability'])) ? '1' : '0',
