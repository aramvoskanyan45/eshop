    ...
    public function update_system_settings()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            if (isset($_POST['is_refer_earn_on']) && $_POST['is_refer_earn_on']) {
                ...
                // $this->form_validation->set_rules('refer_earn_amount_for_referal', 'Refer & Earn Bonus For Referal', 'trim|required|xss_clean');
            ...
            if (!$this->form_validation->run()) {
                ...
                $fields = [
                    'system_configurations', 'system_timezone_gmt', 'system_configurations_id', 'app_name', 'support_number',
                    'support_email', 'copyright_details', 'logo', 'favicon', 'current_version', 'current_version_ios',
                    'is_version_system_on', 'area_wise_delivery_charge', 'delivery_charge', 'min_amount', 'system_timezone',
                    'minimum_cart_amt', 'max_items_cart', 'low_stock_limit', 'max_product_return_days', 'delivery_boy_bonus_percentage',
                    'is_delivery_boy_otp_setting_on', 'cart_btn_on_list', 'tax_name', 'tax_number', 'google_login', 'apple_login',
                    'whatsapp_number', 'android_app_store_link', 'ios_app_store_link', 'scheme', 'host', 'app_store_id', 
                    'default_country_code', 'is_refer_earn_on', 'min_refer_earn_order_amount', 'refer_earn_bonus_times', 
                    'refer_earn_method_for_user', 'refer_earn_bonus_for_user', 'max_refer_earn_amount_for_user', 
                    'refer_earn_method_for_referal', 'refer_earn_bonus_for_referal', 'welcome_wallet_balance_on', 'wallet_balance_amount', 
                    'pincode_wise_deliverability', 'supported_locals', 'currency', 'decimal_point', 'message_for_customer_app', 
                    'message_for_seller_app', 'message_for_delivery_boy_app', 'message_for_web', 'city_wise_deliverability', 'pincode_wise_deliverability'
                ];
